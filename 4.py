...
def extract_url(info):
    ...
    re_url = re.findall(rege, str(info))
    return re_url
...
def extract_sub_web_content(sub_web):
    ...
    re_key = "< div id =\"Cnt-Main-Article-QQ\">[\s\S]*?</div>"
...
# get news
rs = requests.get('http://news.qq.com')
re.encoding = 'utf-8'
content = BeautifulSoup(rs.text, 'html5lib')
